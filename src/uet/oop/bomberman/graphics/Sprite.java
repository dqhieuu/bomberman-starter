...
public class Sprite {
    ...
    public static final int MENU_HEIGHT = 6;
    ...
    public static List<Sprite> menuTitle = new ArrayList<>();
    ...
    public static void loadMenuScreen() {
        for (int x = 0; x < MENU_WIDTH; x++) {
            for (int y = 0; y < MENU_HEIGHT; y++) {
                menuTitle.add(new Sprite(DEFAULT_SIZE, 8 + x, 10 + y, SpriteSheet.tiles, 16, 16));
            }
        }
    }
